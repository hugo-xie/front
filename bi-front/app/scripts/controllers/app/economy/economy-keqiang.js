...
$scope.range2=function(){
  ...
  $scope.keqiangindex={
    ...
    series:[{
        ...
        data: [7.9, 10.1, 9.5, 7.7,12.3,7.4,7.5,7.7,-3.3,9.9,2.4,3.2]
        },
        {
        name: '新增贷款',
        color:"rgb(51,181,88)",
        data: [8.9, 18.1, -18.1, 18.2,32.3,2.2,28.2,1.7,20.0,7.2,22.3,18.7]
        },
        {
        name: '货运量',
        color:"rgb(62,160,200)",
        data: [-3.2, -4.3, -8, -0.7,6.7,8.2,7.3,10.5,4.3,4.7,-0.9,1.2]
        }]
};
